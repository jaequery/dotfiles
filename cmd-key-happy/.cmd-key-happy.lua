...
global_excludes = Set{"cmd-q", "shift-cmd-tab", "cmd-tab", "cmd-space", "shift-cmd-space", "shift-cmd-=", "shift-cmd-m", "control-cmd-left", "control-cmd-right", "control-cmd-up", "control-cmd-down", "control-alt-cmd-left", "control-alt-cmd-right"}
